#ifndef DBUS_VTABLE_HPP
#define DBUS_VTABLE_HPP
#pragma once
...
namespace sdbusplus {
    ...
    namespace vtable {
                                    ...
                                    size_t offset, decltype(vtable_t::flags) flags)
        {
            ...
            v.x.method =
            decltype(v.x.method) {
                member, signature, result, handler, offset
            };
                                  ...
                                  decltype(vtable_t::flags) flags)
        {
            ...
            v.flags = flags;
            v.x.signal = decltype(v.x.signal) {
                member, signature
            };
                                    ...
                                    decltype(vtable_t::flags) flags)
        {
            ...
            v.x.property = decltype(v.x.property) {
                member, signature, get, nullptr, 0
            };
